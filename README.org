...
- *Activity 8*
  ...
  receives credible recognition for their unique contribution. (This part is optimised by ChatGPT 5 on 20th October, 2025)
...
- *Activity 11* \\
 ...
 This is an effective way to generate professional quiz questions based on GAI content. It would be helpful for the lecturers to quickly create practice sessions for students, and the quiz questions could be updated for different terms. The pool of questions could be randomly generated for individuals to ensure integrity. I will consider such an effective GAI-based practice in my units.
